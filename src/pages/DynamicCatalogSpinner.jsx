...
export function getRandomSpinnerDelay() {
  return MIN_SPINNER_DELAY_MS + Math.random() * (MAX_SPINNER_DELAY_MS - MIN_SPINNER_DELAY_MS);
}
    ...
    <div id="page_wrapper" className="page_wrapper">
      <div id="contents_wrapper">
        ...
        <div
          ...
          data-testid="dynamic-catalog-spinner-container">
          {isLoading ? (
            <div
              className="dynamic_catalog_spinner"
              data-testid="dynamic-catalog-spinner"
              role="status"
              aria-label="Loading"
            />
          ) : (
            <div
              ...
              data-testid="dynamic-catalog-spinner-grid">
